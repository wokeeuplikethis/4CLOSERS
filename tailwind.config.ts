...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'hero': ['clamp(3rem, 12vw, 10rem)', { lineHeight: '0.95', letterSpacing: '-0.03em' }],
        'hero-sm': ['clamp(2rem, 8vw, 6rem)', { lineHeight: '1', letterSpacing: '-0.02em' }],
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 40px rgba(255, 61, 0, 0.3)' },
          '50%': { boxShadow: '0 0 80px rgba(255, 61, 0, 0.6)' },
        },
        float: {
